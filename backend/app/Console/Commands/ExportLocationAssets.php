...
class ExportLocationAssets extends Command
{
    ...
    public function handle()
    {
        ...
        $frontendAssetsPath = $projectRoot . '/frontend/assets/locations';
        ...
        $scriptLines = [
            ...
            "echo \"Target directory: frontend/assets/locations\"",
            "mkdir -p frontend/assets/locations",
            ""
        ];
        ...
        foreach ($locaties as $locatie) {
            ...
            foreach ($sectors as $sector) {
                ...
                // Try multiple possible source paths in the script to be robust
                $scriptLines[] = "cp \"backend/{$sourceRelativePath}\" \"frontend/assets/locations/{$targetFileName}\" 2>/dev/null || \\";
                $scriptLines[] = "cp \"backend/public/storage/{$bestandspad}\" \"frontend/assets/locations/{$targetFileName}\" 2>/dev/null || \\";
                $scriptLines[] = "echo \"    Warning: Could not find source for {$targetFileName}\"";
                $scriptCount++;
