...
<template>
    <div class="h-[calc(100vh-4rem)] flex flex-col">
        ...
        <div class="h-16 bg-noir-dark border-b border-noir-panel px-6 flex justify-between items-center z-20">
            <h1 class="text-2xl font-bold text-white tracking-tight">GLOBAL SECTOR MAP</h1>
            <div class="flex gap-4">
                <span class="text-xs text-noir-muted self-center">DRAG SECTORS TO REARRANGE | CLICK NAME TO ENTER</span>
        ...
        <!-- Create Modal -->
         <Modal :isOpen="showCreateModal" title="NEW SECTOR ENTRY" @close="showCreateModal = false">
            <form @submit.prevent="createSector" class="space-y-4">
                ...
                <div class="pt-4 flex justify-end gap-2 text-sm">
                    <button type="button" @click="showCreateModal = false" class="px-4 py-2 text-noir-muted hover:text-white transition-colors">CANCEL</button>
